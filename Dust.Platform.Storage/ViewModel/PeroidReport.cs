...
namespace Dust.Platform.Storage.ViewModel
{
    public class GeneralReportViewModel
    {
        ...
        public List<DistrictDeviceInstalled> DistrictInstalleds { get; set; } = new List<DistrictDeviceInstalled>();

        public List<DistrictAvg> DistrictAvgs { get; set; } = new List<DistrictAvg>();

        public List<ProjectRank> ProjectTopRanks { get; set; } = new List<ProjectRank>();

        public List<ProjectRank> ProjectTailRanks { get; set; } = new List<ProjectRank>();

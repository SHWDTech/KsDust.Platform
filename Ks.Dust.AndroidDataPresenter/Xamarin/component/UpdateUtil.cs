...
using Ks.Dust.AndroidDataPresenter.Xamarin.receiver;
...
namespace Ks.Dust.AndroidDataPresenter.Xamarin.component
{
    public class UpdateUtil
    {
        ...
        public AndroidVersionInfo VersionInfo { get; set; }
        ...
        private static Uri GetDownloadFile(File directory, AndroidVersionInfo info)
        {
            return Uri.FromFile(new File(directory, $"KsDustMonitor-{info.VersionName}.apk"));
        }
